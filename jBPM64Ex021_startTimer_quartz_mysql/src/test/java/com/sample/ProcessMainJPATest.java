 ...
 */
public class ProcessMainJPATest extends TestCase {
...
//        Scanner scanner;
//        if (mySQL) {
//            scanner = new Scanner(ProcessMainJPATest.class.getResourceAsStream("/tables_mysql.sql")).useDelimiter(";");
//        } else {
//            scanner = new Scanner(ProcessMainJPATest.class.getResourceAsStream("/tables_h2.sql")).useDelimiter(";");
//        }
//
//        try {
