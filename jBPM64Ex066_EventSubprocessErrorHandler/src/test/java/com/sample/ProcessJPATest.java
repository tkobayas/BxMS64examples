...
//            RuntimeManager manager = getRuntimeManager("BPMN2-EventSubprocessError.bpmn2");
            RuntimeManager manager = getRuntimeManager("org.jbpm.helloProcess.v1.0.bpmn2");
...
//            ProcessInstance pi = ksession.startProcess("BPMN2-EventSubprocessError", params);
