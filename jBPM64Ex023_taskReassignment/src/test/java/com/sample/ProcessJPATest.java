...
public class ProcessJPATest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            long piid = pi.getId();
            System.out.println("A process instance started : pid = " + piid);
            ...
            // -----------
            {
                ...
                for (TaskSummary taskSummary : list) {
                    System.out.println("mary has a task : taskId = " + taskSummary.getId());
                }
            }
            // Without dispose, scheduler thread will be blocked by processEngineLock
            ...
            // -----------
            {
                List<TaskSummary> list = taskService2.getTasksAssignedAsPotentialOwner("mary", "en-UK");
                for (TaskSummary taskSummary : list) {
                    System.out.println("mary has a task : taskId = " + taskSummary.getId());
                }
            }
