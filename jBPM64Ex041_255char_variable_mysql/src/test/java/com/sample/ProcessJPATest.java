...
public class ProcessJPATest {
    ...
    public void setup() {
        ...
        // modify your db schema as well, for example:
        // alter table VariableInstanceLog modify value varchar(512);
        System.setProperty("org.jbpm.var.log.length", "512");
...
//        configOverrides.put("hibernate.hbm2ddl.auto", "create"); // Comment out if you don't want to clean up tables
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            params.put("Property_1", "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
                    + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
                    + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaxxxxx\n");
            ...
            Object variable = ((WorkflowProcessInstanceImpl)ksession.getProcessInstance(piid)).getVariable("Property_1");
    ...
    public static PoolingDataSource setupDataSource() {
        ...
        pds.getDriverProperties().put("url", "jdbc:mysql://localhost:3306/testbpms640_longvar");
