...
public class ProcessJPATest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            ksession.getWorkItemManager().registerWorkItemHandler( "Service Task", new org.jbpm.process.workitem.bpmn2.ServiceTaskHandler() );
            ...
            ProcessInstance pi = ksession.startProcess("Demo.Hello", params);
