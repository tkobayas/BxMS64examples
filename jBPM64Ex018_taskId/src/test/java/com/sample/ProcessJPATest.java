        ...
        try {
            ...
            // ------------
            {
                ...
                for (TaskSummary taskSummary : list) {
                    ...
                    results.put( "myTaskId", taskSummary.getId() );
...
//            ProcessInstance pi2 = ksession2.startProcess("com.sample.bpmn.hello", params2);
//            System.out.println("A process instance started : pid = " + pi2.getId());
//            
