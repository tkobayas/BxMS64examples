    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            // -----------
            {
                ...
                query.setExpression("select pi.* " + "from processinstancelog pi ");

                queryService.registerQuery(query);
                List<ProcessInstanceDesc> piList = queryService.query(query.getName(), ProcessInstanceQueryMapper.get(), new QueryContext());
                for (ProcessInstanceDesc pidesc : piList) {
                    System.out.println(pidesc);
                }
