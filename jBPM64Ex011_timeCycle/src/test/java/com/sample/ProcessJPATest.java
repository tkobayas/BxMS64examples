...
public class ProcessJPATest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            RuntimeManager manager = getRuntimeManager("IntermediateCatchEventTimerCycle3.bpmn2");
            ...
            ProcessInstance pi = ksession.startProcess("IntermediateCatchEvent", params);
