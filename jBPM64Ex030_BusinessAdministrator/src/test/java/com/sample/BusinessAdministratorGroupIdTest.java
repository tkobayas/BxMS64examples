 ...
 */
public class BusinessAdministratorGroupIdTest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            RuntimeManager manager = getRuntimeManager("sample-BusinessAdministratorGroupId.bpmn");
            ...
            // ------------
            {
                List<TaskSummary> list = taskService.getTasksAssignedAsBusinessAdministrator("MyAdmin", "en-UK");
                for (TaskSummary taskSummary : list) {
                    System.out.println("MyAdmin starts a task : taskId = " + taskSummary.getId());
                    taskService.start(taskSummary.getId(), "MyAdmin");
                    taskService.complete(taskSummary.getId(), "MyAdmin", null);
                }
            }
    ...
    private static RuntimeManager getRuntimeManager(String process) {
        ...
        properties.setProperty("krisv", "PM,HR");
        properties.setProperty("mary", "HR");
        properties.setProperty("john", "PM");
        properties.setProperty("MyAdmin", "MyAdminGroup");
