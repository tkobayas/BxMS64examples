...
public class ProcessJPATest {
    ...
    public void testProcess() throws Exception {
        ...
        try {
            ...
            properties.add( "DEF" );
            properties.add( "1" );
            CorrelationKey key = factory.newCorrelationKey( properties );

            long start = System.currentTimeMillis();
            ProcessInstance pi = ((CorrelationAwareProcessRuntime) ksession).startProcess( "com.sample.bpmn.hello", key, params );
            System.out.println( "A process instance started : pid = " + pi.getId() + ", elapsed time = " + (System.currentTimeMillis() - start) + "ms" );
